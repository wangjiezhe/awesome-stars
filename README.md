...
- [tautcony/ChapterTool](https://github.com/tautcony/ChapterTool) - Cross-platform chapter editing and conversion toolkit for desktop, CLI, WebAssembly, and Node.js, with support for Blu-ray and common media chapter formats.
...
- [N0I0C0K/PowerTranslator](https://github.com/N0I0C0K/PowerTranslator) - 一个 PowerToys Run 和 Cmdpal 的翻译插件/a translate plugin for PowerToys Run and Cmdpal
...
- [rollecode/typora-writing-theme](https://github.com/rollecode/typora-writing-theme) - A simple Typora theme just for distract-free writing.
...
- [AloysHF/cnblogs](https://github.com/AloysHF/cnblogs) - 一些我在平时工作和学习中积累的编程相关的资源。如果大家有兴趣可以一起增加，修改。
...
- [AnYi-0/Translator](https://github.com/AnYi-0/Translator) - 一个基于 Chrome 138+ 新增的本地 Translator API 和 Language Detector API 的离线轻量级翻译扩展，支持自动检测网页语言、自动翻译网页、离线翻译（首次可能需下载模型）、快速出结果。
...
- [ipcjs/oh-my-userscripts](https://github.com/ipcjs/oh-my-userscripts) - 我的油猴脚本仓库
...
- [liguobao/HouseSearch](https://github.com/liguobao/HouseSearch) - 地图搜租房：满大街找租房心力交瘁？试试换个方式直接在地图上搜租房!【微信公众号、小程序：人生删除指南】
...
- [formal-land/rocq-of-ocaml](https://github.com/formal-land/rocq-of-ocaml) - Formal verification for OCaml, with Rocq
...
- [dongyubin/Awesome-AI-Images-Prompts](https://github.com/dongyubin/Awesome-AI-Images-Prompts) - 2026年8月更新，精选适用于 GPT Image 2、Gemini Nano-banana Pro Image Prompts、即梦、豆包 Seedream 4.0、Hunyuan 3.0、ChatGPT-4o、Grok Image、FLUX、Ideogram、Imagen、Leonardo Ai、Midjourney、Seedance 2.0等AI生图大模型的提示词
...
- [Translate-with-LOVE/Ra2-zh_hans-main](https://github.com/Translate-with-LOVE/Ra2-zh_hans-main) - 用爱发电，也许有朝一日能完成中文配音的Ra2呢？（Ra2简体汉化）
...
- [tw93/Luo](https://github.com/tw93/Luo) - Luo 落文：正在造字中的中文字体，面向纸面排版和长文阅读。
...
- [ChaceQC/bilibili_live_stream_code](https://github.com/ChaceQC/bilibili_live_stream_code) - 获取B站直播推流码，支持开关播，管理直播标题、分区，显示弹幕和礼物。
...
- [0xbw/midea-msmart](https://github.com/0xbw/midea-msmart) - This is a library to allow communicating to a Midea AC via the Local area network.
- [0xbw/midea-ac-py](https://github.com/0xbw/midea-ac-py) - Home Assistant Custom Integration for Midea Group(Hualing, Senville, Klimaire, AirCon, Century, Pridiom, Thermocore, Comfee, Toshiba, Carrier, Goodman, Friedrich, Samsung, Kenmore, Trane, Lennox, LG a
...
- [redguardtoo/pyim2fcitx](https://github.com/redguardtoo/pyim2fcitx) - Convert pyim dictionary to fcitx dictionary
...
- [geosolutions-it/osm-styles](https://github.com/geosolutions-it/osm-styles) - OSM Bright styles for GeoServer (at last!)
...
- [nerdyjem/zshmarks](https://github.com/nerdyjem/zshmarks) - A port of Bashmarks (simple bookmarking plugin by Todd Werth) for oh-my-zsh
...
- [iamjarryfeng/Waseda-Beamer-Slide](https://github.com/iamjarryfeng/Waseda-Beamer-Slide) - A LaTeX beamer theme template for Waseda Univ. students.
...
- [deuslirio/UFGTeX-Presentation](https://github.com/deuslirio/UFGTeX-Presentation) - A Modern LaTeX Template to presentations, with different layouts and support to AI assistants
...
- [TeXlyre/texlyre-busytex](https://github.com/TeXlyre/texlyre-busytex) - WASM BusyTeX API for TeX Live 2026 (01.03.26) supporting LuaTeX, PdfTeX, & XeTeX in the browser
